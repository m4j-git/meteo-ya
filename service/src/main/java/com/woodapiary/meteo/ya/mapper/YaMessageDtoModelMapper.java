...
import com.woodapiary.meteo.ya.domain.*;
...
import com.woodapiary.meteo.ya.model.YaPartDto;
...
public class YaMessageDtoModelMapper {
    ...
    @PostConstruct
    public void init() {
        modelMapper.createTypeMap(YaMessageDto.class, YaMessage.class)
                .addMapping(YaMessageDto::getFact, YaMessage::addFact)
